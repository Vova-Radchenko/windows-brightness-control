...
#define MyAppPublisher "Volodymyr Radchenko"
#define MyAppExeName "BrightnessControl.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{13EF168E-91E9-49F9-BA75-EAF1E671560F}
AppName={#MyAppName}
...
[Files]
Source: "D:\Vova\Projects\Python_Projects\Brightness_control\dist\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
